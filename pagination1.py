...
page_data = st.session_state.edited_data.iloc[start:end]
...
st.session_state.edited_data.iloc[start:end] = edited_data

# Save button
if st.button('Save'):
    st.session_state.edited_data.to_csv('edited_data.csv', index=False)
